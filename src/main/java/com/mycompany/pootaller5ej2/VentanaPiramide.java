package com.mycompany.pootaller5ej2;
  ...
  public void actionPerformed(ActionEvent event){
      Piramide piramide1;
        ...
        try {
            ...
            volumen.setText("Volumen (cm3): " + String.format("%.2f",piramide1.calcularVolumen()));
            superficie.setText("Superficie (cm2): " + String.format("%.2f",piramide1.calcularSuperficie()));
        } catch (Exception e) {
            error = true; 
        } finally {
            if (error) {
